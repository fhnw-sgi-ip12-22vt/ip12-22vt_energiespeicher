...
public class Ads1115_App implements Application {
    ...
    private void singleRead(Context pi4j) {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            System.out.println(
                    "[" + i + "] Voltages: a0=" + String.format("%.3f", aIn0) + " V, a1=" + String.format("%.3f", aIn1)
    ...
    private void continuousSlowRead(Context pi4j) {
        ...
        ads1115.setConsumerSlowReadChannel0((value) -> System.out
                .println("The actual value from channel 0 is: " + String.format("%.3f", value) + "voltage."));
        ads1115.setConsumerSlowReadChannel1((value) -> System.out
                .println("The actual value from channel 1 is: " + String.format("%.3f", value) + "voltage."));
        ads1115.setConsumerSlowReadChannel2((value) -> System.out
                .println("The actual value from channel 2 is: " + String.format("%.3f", value) + "voltage."));
        ads1115.setConsumerSlowReadChannel3((value) -> System.out
                .println("The actual value from channel 3 is: " + String.format("%.3f", value) + "voltage."));
    ...
    private void continuousFastRead(Context pi4j) {
        ...
        ads1115.setConsumerFastRead((value) -> {
            System.out.println(
                    "The actual value from fast read channel is: " + String.format("%.3f", value) + "voltage.");
        });
