...
public class Potentiometer extends Component {
    ...
    /**
     * Create a new potentiometer component with custom channel and custom
     * maxVoltage
     *
    ...
    /**
     * Create a new potentiometer component with default channel and maxVoltage for
     * Raspberry pi
     *
     * @param ads1115 ads instance
     */
    ...
    /**
     * start slow continuous reading. In this mode, up to 4 devices can be connected
     * to the analog to digital
     * converter. For each device a single read command is sent to the ad converter
     * and waits for the response.
     * The maximum sampling frequency of the analog signals depends on how many
     * devices are connected to the AD
     * converter at the same time.
     * The maximum allowed sampling frequency of the signal is 1/2 the sampling rate
     * of the ad converter.
     * The reciprocal of this sampling rate finally results in the minimum response
     * time to a signal request.
     * (the delay of the bus is not included).
     * <p>
     * This leads to the following table for the maximum allowed readFrequency by a
     * sampling rate of 128 sps:
    ...
    /**
     * Starts fast continuous reading. In this mode only on device can be connected
     * to the ad converter.
     * The maximum allowed readFrequency ist equal to the sample rate of the ad
     * converter
     *
     * @param threshold     threshold for trigger new value change event (+-
     *                      voltage)
