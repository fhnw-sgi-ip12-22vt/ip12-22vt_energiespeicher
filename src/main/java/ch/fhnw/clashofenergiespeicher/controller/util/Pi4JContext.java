package ch.fhnw.clashofenergiespeicher.controller.util;
 ...
 * <p>
 * These applications need to run on desktop (for development) and on Raspberry
 * Pi.
 * <p>
 * In desktop environment the Pi4J MockPlatform is used, on Raspberry Pi the
 * Pi4J RaspberryPiPlatform.
 */
