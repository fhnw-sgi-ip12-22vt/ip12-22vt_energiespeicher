 ...
 * <p>
 * Controller classes work on and manage the Model. Models encapsulate the whole
 * application state.
 * <p>
 * Controllers provide the whole core functionality of the application, so
 * called 'Actions'
 * <p>
 * Execution of Actions is asynchronous. The sequence is kept stable, such that
 * for all actions A and B: if B is submitted after A, B will only be executed
 * after A is finished.
 */
public abstract class ControllerBase<M> {
    ...
    /**
     * Schedule the given action for execution in strict order in external thread,
     * asynchronously.
     * <p>
    ...
    /**
     * Schedule the given action after all the actions already scheduled have
     * finished.
     *
     */
     ...
     * <p>
     * Best solution would be that 'action' of 'runLater' is executed on calling
     * thread.
     * <p>
    ...
    /**
     * Only the other base classes 'ViewMixin' and 'PUI_Base' need access, therefore
    ...
    /**
     * Utility function to pause execution of actions for the specified amount of
     * time.
     * <p>
    ...
    protected static class Setter<V> {
        ...
        // supplier is used here to get the value at execution time and not at
        // registration time
