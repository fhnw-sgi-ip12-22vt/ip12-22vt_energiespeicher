...
public final class ObservableValue<V> {
     ...
     *
     * This is method is 'package private', only 'ControllerBase' is allowed to set
     * a new value.
     *
    ...
    void setValue(V newValue) {
        ...
        listeners.forEach(listener -> {
            if (value.equals(newValue)) { // pre-ordered listeners might have changed this and thus the callback no
                                          // longer applies
