...
interface Projector<M, C extends ControllerBase<M>> {
    ...
    /**
     * completely initialize all necessary UI-elements (like buttons, text-fields,
     * etc. on GUI or distance sensors on PUI )
     */
     ...
     *
     * If you are about to call more than one method, you should introduce a new
