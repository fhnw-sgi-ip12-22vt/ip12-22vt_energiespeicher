package ch.fhnw.clashofenergiespeicher.controller.util.mvcbase;
...
/**
 * Use this interface for all of your GUI-parts to assure implementation
 * consistency.
 *
...
public interface ViewMixin<M, C extends ControllerBase<M>> extends Projector<M, C> {
     ...
     *
     * @return a 'Converter' to specify a function converting the type of
     *         'ObservableValue' into the type of the 'Property'
     */
    ...
    record Converter<V>(ObservableValue<V> observableValue) {
        ...
        /**
         * Second (optional) step for registering an observer to specify a
         * converter-function
         *
         * @param converter the function converting the type of 'ObservableValue' into
         *                  the type of the 'Property'
         * @return an Updater to specify the 'GUI-Property' that needs to be updated if
        ...
        /**
         * Registers an observer without any type conversion that will keep
         * property-value and observableValue in sync.
         *
         * @param property GUI-Property that will be updated when observableValue
         *                 changes
         */
        ...
        public void execute(ObservableValue.ValueChangeListener<V> listener) {
            observableValue
                    .onChange((oldValue, newValue) -> Platform.runLater(() -> listener.update(oldValue, newValue)));
        }
    }
    ...
    record Updater<V, P>(ObservableValue<V> observableValue, Function<V, P> converter) {
        ...
        /**
         * Registers an observer that will keep observableValue and GUI-Property in sync
         * by applying the specified converter.
         *
         * @param property GUI-Property that will be updated when observableValue
         *                 changes
         */
