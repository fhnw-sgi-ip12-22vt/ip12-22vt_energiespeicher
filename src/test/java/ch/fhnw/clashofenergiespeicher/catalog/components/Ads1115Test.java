...
import ch.fhnw.clashofenergiespeicher.catalog.ComponentTest;
...
public class Ads1115Test extends ComponentTest {
    ...
    public void setUp() {
        ...
        when(mockI2C.writeRegisterWord(CONFIG_REGISTER,
                defaultConfigRegister | Ads1115.MUX.AIN0_GND.getMux() | Ads1115.MODE.SINGLE.getMode()))
                .thenReturn(answerSingleShotAIN0ConfigRegister);
    ...
    public void testWriteConfigRegister() {
        ...
        // then
        assertEquals(answerSingleShotAIN0ConfigRegister, ads1115.writeConfigRegister(
                defaultConfigRegister | Ads1115.MUX.AIN0_GND.getMux() | Ads1115.MODE.SINGLE.getMode()));
    }
    ...
    public void testFastContinuousReading() {
        // given
        int conversionRegisterValue = 16000;
        answerConfigRegister = defaultConfigRegister | Ads1115.MUX.AIN3_GND.getMux()
        ...
        when(mockI2C.readRegisterWord(CONVERSION_REGISTER))
                .thenReturn(conversionRegisterValue + deltaConversionRegister);
