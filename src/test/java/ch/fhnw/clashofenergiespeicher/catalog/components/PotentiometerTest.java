...
public class PotentiometerTest extends ComponentTest {
    ...
    // Assertions.assertEquals(voltageFromAdConverter,
    // potentiometer.singleShotGetVoltage());
    // }
    //
    // @Test
    // public void testSingleShotGetNormalizedValue(){
    // Assertions.assertEquals(voltageFromAdConverter/potentiometer.getMaxValue() ,
    // potentiometer.singleShotGetNormalizedValue());
    // }
    //
    // @Test
    ...
    //
    // Assertions.assertThrows(ContinuousMeasuringException.class,
